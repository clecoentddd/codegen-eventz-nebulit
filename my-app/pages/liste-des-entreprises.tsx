...
import ListeDesEntreprisesDepuisBoond from '../app/src/slices/SliceListeDesEntreprises/ui/ListeDesEntreprisesDepuisBoond';

export default function SliceListeDesEntreprisesPage() {
    return (
            ...
            <main className="mx-auto max-w-6xl px-4 pb-16">
                <header className="mt-10 grid gap-6 md:grid-cols-[1.2fr_0.8fr] md:items-center">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-3xl font-semibold text-slate-900 sm:text-4xl">slice: Liste des entreprises</h1>
                ...
                <section className="mt-10 grid gap-6">
                    <ListeDesEntreprisesDepuisBoond />
                </section>
            </main>
        </div>
    );
