...
import { PrepareInvitationUI } from '../app/src/slices/SlicePrepareInvitation/ui/PrepareInvitationUI';

export default function SlicePrepareInvitationPage() {
    return (
            ...
            <main className="mx-auto max-w-6xl px-4 pb-16">
                <header className="mt-10 grid gap-6 md:grid-cols-[1.2fr_0.8fr] md:items-center">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-3xl font-semibold text-slate-900 sm:text-4xl">slice: Prepare Invitation</h1>
